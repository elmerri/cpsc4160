...
bool PerPixelCollisionStrategy::execute(const Drawable& obj1, const Drawable& obj2) const {
  ...
  sides.reserve(4);
  sides.emplace_back( o1Left );
  sides.emplace_back( o1Right );
  sides.emplace_back( o2Left );
  sides.emplace_back( o2Right );
  ...
  std::vector<int> lids;
  lids.reserve(4);
  lids.emplace_back( o1Up );
  lids.emplace_back( o1Down );
  lids.emplace_back( o2Up );
  lids.emplace_back( o2Down );
